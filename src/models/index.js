...
const agencies = {
  publicis: {
    ...
    users:[
      ...
      {id:16160,groupAdv:['publicis-other','publicis-bh','publicis-bolt','publicis-samsung','publicis-winner','publicis-sandoz','publicis-biosphere']}, // Bohdan Radchenko (Zenith / Publicis Groupe)
...
const ProposalMix = sequelize.define('proposalmix', {
  ...
  printMaterialId  : int('id_print_material'),
  technicalRequirementID: varchar('TR'),
  hide_doors_data     : int()
}, {
  tableName: 'v_web_proposals_mix',
  hasTrigger: true,
...
const MonitoringData = sequelize.define('PhotoMonitoringData', {
  id			          : id('id'),
  MonitoringId      : int('id_monitoring'),
  date			        : varchar('date'),
  ConstrFotomonitor : int('id_fotomonitor'),
  num               : float('num'),
  supplierNo        : varchar('[supplier_number]'),
  city			        : varchar('[city]'),
  address		        : varchar('[address_ukr]'),
  OwnerId           : int('[id_supplier'),
  Owner			        : varchar('[supplier]'),
  sizeTypeId        : int('[id_sizetype]'),
  size		          : varchar('[size]'),

  //advertisingCategory: varchar('[Advertising category]'),
  advertising    		 : varchar('[Advertising]'),
  advevents		       : varchar('[Advevents]'),
  brand    		       : varchar('[Brand]'),
  catab    		       : varchar('[А/Б]'),
  damage             : varchar('[Damage]'),
  note    	         : varchar('[Note]'),
  posterType     		 : varchar('[poster_type]'),
  ...
  photorecId         : varchar('[id_photorec]'),
  contrtypeId        : int('[id_contrtype]'),
  categoryId         : int('[id_category]'),
  photoId            : int('[id_photo]'),
  linked             : int('[linked]'),
  ots                : float('[OTS]'),
  ...
  tableName: 'v_photo_monitoring_data',
  hasTrigger: true,
  scopes : {
    rls () {
      return {
...
//   'brandId'
// ])
// const MonitoringData = sequelize.define('v_photo_monitoring_data', {
//   id			          : id('id'),
//   MonitoringId      : int('id_monitoring'),
//   date			        : varchar('date'),
//   sideFotomonitor   : int('id_fotomonitor'),
//   num               : float('num'),
//   supplierNo        : varchar('[supplier_number]'),
//   city			        : varchar('[city]'),
//   address		        : varchar('[address_ukr]'),
...
//   monitoringAdeventsId : int('[id_adevent]'),
//   monitoringBrandId    : int('[id_brand]'),
...
// }, {
//   tableName: 'v_photo_monitoring_data_v2',
//   hasTrigger: true,
//   scopes : {
//     rls () {
//       return {
...
const MonitoringBrand = sequelize.define('monitoringBrand',{
  id        : id('id'),
  brand     : varchar('name'),
}, {
  tableName: 'v_reference_monitoring',
  scopes: {
    rls () {
      return {
        rls: true,
...
const MonitoringAdevents = sequelize.define('monitoringAdevents',{
  id        : id('id'),
  adevent     : varchar('name'),
}, {
  tableName: 'v_reference_monitoring',
  scopes: {
    rls () {
